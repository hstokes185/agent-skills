...
Production rules for the agentic business case builder, drawn from production experience building decks with this skill. These sit alongside `SKILL.md` and `deck-structure.md` and take precedence where they conflict.
